...
function draw_bounds(x1, y1, x2, y2)
    ...
    top_bound:setCollidesWithGroups({ paddle_coll_group })
    ...
    bottom_bound:setCollidesWithGroups({ paddle_coll_group })
    ...
    left_bound:setCollidesWithGroups({ paddle_coll_group })
    ...
    right_bound:setCollidesWithGroups({ paddle_coll_group })
end